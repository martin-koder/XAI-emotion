...
#this model is taken from: http://www.robots.ox.ac.uk/~albanie/models/pytorch-mcn/vgg_vd_face_fer_dag.py
class Vgg_vd_face_fer_dag(nn.Module): #see https://www.robots.ox.ac.uk/~albanie/models/pytorch-mcn/vgg_vd_face_fer_dag.py
